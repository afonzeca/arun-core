...
namespace ArunCore\Facades;

use ArunCore\Core\App;

abstract class FacadeAbstract
{
    public static abstract function getInterfacePath();
    ...
    {
        $theClass = App::make(static::getInterfacePath());
        $theClass->$name(...$arguments);
    }
